...
": "u2029"
        ...
        f = function () {
            ...
            return o("div", {
                ...
                return o("option", {
                    ...
                    domProps: {
                        value: t.id,
                        selected: (n.$root.base + n.$root.offset % 17 + 17) % 17 == e
                    }
    ...
    var g = p({
        ...
        methods: {
            notaActivator(n) {
                return (this.$root.base + this.$root.offset % 17 + 17) % 17 == m.a.findIndex(this.$root.notaList, t => t.id === n) ? "active" : ""
            },
            setActive(n) {
                this.$root.offset = m.a.findIndex(this.$root.notaList, t => t.id === n) - this.$root.base
            },
            getActive() {
                var n = this.$root.notaList[(this.$root.base + this.$root.offset % 17 + 17) % 17];
        ...
        methods: {
            esasNota(n, t) {
                var o = {
                    ...
                    r = void 0 === e ? o : m.a.find(this.$root.notaListConcat, n => n.indexer[0] === ((e.indexer[0] + t) % 17 + 17) % 17 && n.indexer[1] === e.indexer[1]) || o;
                return this.$root.displayAlternating ? r.label : r.id
            },
            shouldBeFree() {
    ...
    window.vuefy = () => {
        ...
        w.eachLimit(n, 5, (n, t) => {
            new r.a({
                ...
                mounted() {
                    this.base = k.find(A, n => n.id === k.head(k.filter(this.$root.$children, n => "nota-component" === n.$options._componentTag)).$props.nota).indexer[0], this.setSize(), this.$nextTick(() => {
